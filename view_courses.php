...
if (isset($_GET['teacher_id'])) {
    ...
    $sql2 = "DELETE FROM courses WHERE sno='$t_id'";
    ...
    <center>
      ...
      <table>
        ...
        <tr>
          ...
          <td class="table_td">
                <a class='deleteButton' href='view_courses.php?teacher_id=<?php echo $info["sno"]; ?>' onclick="return confirm('Are you sure you want to delete this?');">Delete</a>
            </td>
