    ...
    <div class="green">
      ...
      <table>
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align:left;">[bsc 103] Mathematics I</td>
              <td>4</td>
              <td>70/30</td>
              <td>A+</td>
            </tr>
            <tr>
              <td style="text-align:left;">[Esc 101] Basic Electrical Engineering  </td>
              <td>4</td>
              <td>70/30</td>
              <td>A+</td>
            </tr>
            ...
            <tr>
              <td style="text-align:left;"  >[bsc 105] Engineering  Graphics  and Drawing </td>
              <td>4</td>
              <td>70/30</td>
              <td>A+</td>
            </tr>
            <tr>
              <td style="text-align:left;">[bsc 101P] physics Lab</td>
              <td>4</td>
              <td>70/30</td>
              <td>A</td>
            </tr>
            <tr>
              <td style="text-align:left;">[bsc 101P] Basic Electrical Engineering lab</td>
              <td>4</td>
              <td>70/30</td>
              <td>A+</td>
            </tr>
